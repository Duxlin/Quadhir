...
//=================================================//
// Other
global.owner = ['79818648925']
global.premium = ['79818648925']
...
global.sp = '⭔'
global.mess = {
    nsfw: '*NSFW feature not enabled, chat with admin to be activated*_',
    wait: '*Loading... Sabar Wibu*_',
    private: 'Feature used only in private chat!',
    bot: 'Special Features for bot number users',
    endLimit: 'Your daily limit has been exhausted, the limit will be reset serially at 12',
    verif: 'Hey 👋 Silahkan Verifikasi Terlebih Dahulu Agar Bisa Menggunakan Bot Hw Mods',
}
//=================================================//
